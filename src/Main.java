...
public class Main {
	public static void main(String[] args) {
		...
		FunctionalChainInvolvments_function fcif2 = new FunctionalChainInvolvments_function(UUID.randomUUID().toString(), "fcif2", "fcif2");
		fcif2.setFunction(f2);
		FunctionalChainInvolvments_function fcif3 = new FunctionalChainInvolvments_function(UUID.randomUUID().toString(), "fcif3", "fcif3");
		fcif3.setFunction(f3);
		FunctionalChainInvolvments_function fcif4 = new FunctionalChainInvolvments_function(UUID.randomUUID().toString(), "fcif4", "fcif4");
		...
		fe1.setOutput(o1);
		fe1.setInput(i1);
		FunctionalExchange fe2 = new FunctionalExchange(UUID.randomUUID().toString(), "fe2", "Exchange1");
		fe2.setOutput(o2);
		fe2.setInput(i2);
		FunctionalExchange fe3 = new FunctionalExchange(UUID.randomUUID().toString(), "fe3", "Exchange1");
		fe3.setOutput(o3);
		fe3.setInput(i3);
		FunctionalExchange fe4 = new FunctionalExchange(UUID.randomUUID().toString(), "fe4", "Exchange1");
		fe4.setOutput(o4);
		fe4.setInput(i4);
		FunctionalExchange fe5 = new FunctionalExchange(UUID.randomUUID().toString(), "fe5", "Exchange1");
		fe5.setOutput(o5);
		fe5.setInput(i5);
